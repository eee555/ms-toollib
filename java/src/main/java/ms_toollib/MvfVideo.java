...
public class MvfVideo implements AutoCloseable {
    private long nativePtr;
    private BaseVideo dataView;

    public MvfVideo(String fileName) { nativePtr = nativeNew(fileName); }
    public MvfVideo(byte[] rawData, String fileName) { nativePtr = nativeNewFromData(rawData, fileName); }
