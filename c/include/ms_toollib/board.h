...
struct Board laymine_op(size_t row, size_t column, size_t MineNum, size_t X0, size_t Y0);
uint8_t is_solvable(struct Board board, size_t X0, size_t Y0);
struct BoardReturn laymine_solvable(size_t row, size_t column, size_t MineNum, size_t X0, size_t Y0, size_t max_times);
struct BoardReturn laymine_solvable_adjust(size_t row, size_t column, size_t MineNum, size_t X0, size_t Y0);
