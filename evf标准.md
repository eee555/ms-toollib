...
15. 以'\0'结尾字符串、'utf-8'编码、仅转码录像有此字段：转码软件的名称，包括软件名称和版本号。可能的值包括"元 3.2.1"、"元 3.2.2"等。假如为空，说明本录像为软件直接产生，而不是转码得来。
...
11. 以'\0'结尾字符串：录像的来源。如来自元扫雷 3.1，则为"元 3.1"。排名网站需要检查录像的来源。
