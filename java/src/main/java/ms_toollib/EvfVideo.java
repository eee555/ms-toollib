...
public class EvfVideo implements AutoCloseable {
    private long nativePtr;
    private BaseVideo dataView;

    public EvfVideo(String fileName) { nativePtr = nativeNew(fileName); }
    public EvfVideo(byte[] rawData, String fileName) { nativePtr = nativeNewFromData(rawData, fileName); }
