...
public class AvfVideo implements AutoCloseable {
    private long nativePtr;
    private BaseVideo dataView;

    public AvfVideo(String fileName) { nativePtr = nativeNew(fileName); }
    public AvfVideo(byte[] rawData, String fileName) { nativePtr = nativeNewFromData(rawData, fileName); }
